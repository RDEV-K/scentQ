...
class CreateProductFamilyRelationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_family_relation', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('product_family_relation');
    }
}
