...
use App\Jobs\StripeWebhooks\SubscriptionCanceled;
use App\Jobs\StripeWebhooks\SubscriptionDeleted;
...
return [
    ...
    'jobs' => [
        ...
        'subscription_schedule_canceled' => SubscriptionCanceled::class,
        'subscription_schedule_aborted' => SubscriptionCanceled::class,
        'customer_subscription_deleted' => SubscriptionDeleted::class,
    ],
