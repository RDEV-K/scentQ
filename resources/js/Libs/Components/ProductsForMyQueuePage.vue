    ...
    <div class="position-relative">
        <div class="row g-2 products-list-row" v-if="products.length > 0">
            <div class="col-6 col-xl-4" v-for="(product, productIndex) in products" :key="productIndex">
                <Product @click="$emit('close-modal')" :product="product" :from="from" :month="month" :year="year" />
            </div>
        </div>
...
<script>
    ...
    import Product from "@/Libs/Components/Products/BigProductForMyQueuePage.vue";
