<template>
    <div class="small-product-card tw-mx-3 tw-w-full !tw-bg-secondary">
        <!-- <div class="square-btn-box">
            <AddToQueueButton class="btn btn-black" :product="product">
                <img
                    src="../../../../images/svg/Ico_square_Plus.svg"
                    class="img-fluid"
                />
            </AddToQueueButton>
        </div> -->
        ...
        <div class="product-rating !tw-mb-4 tw-mt-2">
            ...
            <!-- <img src="../../../../images/svg/color_Ico_Star.svg" class="img-fluid" v-for="index in crate" :key="index"
                :alt="product.title + ' image'" />
            <img src="../../../../images/svg/gry-Ico_Star.svg" class="img-fluid" v-for="index in (5 - crate)" :key="index"
                :alt="product.title + ' image'" /> -->
        </div>
