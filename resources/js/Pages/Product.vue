<template>
    <Transition name="slide">
        <div>
                ...
                <div class="container">
                    <div class="breadcrumb-tab-wrap">
                        <div class="breadcrumb-wrap md:tw-px-0 tw-px-4">
                            <p>
                                <Link class="text-decoration-none brand_bredcrumb tw-text-[#000]"
                                    :href="route('index')">
                                {{ __('Home') }}</Link>
                                /
                                <Link class="notranslate text-decoration-none brand_bredcrumb tw-text-[#000]"
                                    :href="route('brand', brand.slug)">{{ brand.name }}</Link>
                            ...
                            <div class="tabs">
                                <ul>
                                    <li v-for="tab in tabs" :key="tab.id" :class="{ active: currentTab === tab.id }">
                                        <a href="#" @click.prevent="scrollToSection(tab.id)">{{ tab.title }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <section class="product-details collection-section !tw-bg-primary" id="detail">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-1">
                            <div class="prodImage_thumbs">
                                <div class="thumbs" v-for="(image, imageIndex) in product.images" :key="imageIndex"
                                    :data-image="image.url" @click="currentSlideStart(imageIndex)" :class="imageIndex == activeIndex ? 'active_thumb !tw-bg-secondary' : ''
                                        ">
                        ...
                        <!-- Product slider -->
                        <div class="col-lg-4">
                            <div class="Products_Carousel_Wrapper !tw-bg-secondary">
                                <carousel ref="vueCarouselMain" :settings="slickSettingsForProductImages"
                                    :transition="1000" :autoplay="true" pauseAutoplayOnHover="true" :itemsToShow="1"
                                    ...
                                    <slide class="product-img-box text-center"
                                        ...
                                        <iframe v-else height="443" style="width: 416px" :src="image.url"
                                            frameborder="0"
                            ...
                            <div class="product-details-content">
                                ...
                                <div class="subscriptions-wrapper" v-if="cpurchaseOptions.length">
                                    <div v-for="(purchaseOption,
                                            ...
                                            <template
                                                ...
                                                <AddToCartButton
                                                    ...
                                                    <p
                                                        ...
                                                        plan ? $page?.props?.fiftyPercentOffAmount :
                                                        purchaseOption.price) }}</p>
                                                </AddToCartButton>
                                            </template>
                                        ...
                                        <div v-if="product.purchase_options[purchaseOptionIndex].type === 'subscription' && alreadySubscribed() == 0 && $page?.props?.config?.app?.subscribe_discount_status"
                                            class="!tw-mb-2 !tw-text-base">
                                            <strong>
                                                {{ currencyConvert(purchaseOption.type ===
                                                "subscription" && plan ? $page?.props?.fiftyPercentOffAmount :
                                                purchaseOption.price) }}
                                            </strong>
                                ...
                                <a href="#" class="black-link" @click.prevent="openDisclaimerModal">
                                    {{ __("Disclaimer") }}
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <carousel :settings="slickSettingsForNotes" :transition="1000"
                            ...
                            <slide class="col-md-2" v-for="(note, noteIndex) in product.notes" :key="noteIndex">
                                <div class="single-trending-note !tw-bg-secondary text-center cursor-pointer"
                            ...
                            <div class="col-md-12" v-for="(note, noteIndex) in product.notes" :key="noteIndex">
                                <p :class="[
                                    ...
                                    <a @click.prevent="openNoteModal(noteIndex)"
                                        class="black-link arrow_link cursor-pointer">{{ __(('Explore fragrances with'))
                                        }} {{
                                        note.name }}
            ...
            <section id="related-product" v-if="related_products.length"
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-between mb-3">
                        <div class="col-md-12">
                            <h2
                                v-html="__('People Who Prefer :product Also Like',{ product:'<strong>' + product.title + '</strong>' })">
                            </h2>
                        </div>
                    </div>
            ...
            <section id="review" class="review-summery product collection-section !tw-bg-primary" ref="review_summery">
                <div class="container">
                    <div class="product-reviews !tw-bg-transparent">
                        <div class="row">
                            <div class="col-lg-4">
                                <h2>{{ __("reviews") }}</h2>
                                        ...
                                        <div class="review-rating-box">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar"
                                                    :style="{ width:reviewPercent(reviewCountGroup.count) + '%'}"
                                                    :aria-valuenow="reviewPercent(reviewCountGroup.count)"
                    ...
                    <div class="row align-items-center justify-content-between" id="user_feedbacks">
                        <div class="col-md-6">
                            <h2>
                                {{ __("Feedback") }}
                                <span>
                                    {{ __(":s Feedbacks", {s:product.reviews_count}) }}
                                </span>
                            </h2>
                        </div>
                    </div>
                            ...
                            <div class="feedback-user-details">
                                <div class="name-img-container">
                                    <img :src="review?.reviewer_avatar"
                                        class="img-fluid tw-border-2 tw-border-black tw-shadow-xs"
            ...
            <Teleport to="body">
                        ...
                        <div class="modal-content container">
                            ...
                            <div class="modal-body mb-4">
                                ...
                                <div class="product-type mt-5" v-for="(brandProductTypeProducts,
                                    ...
                                    <h4>
                                        {{ brandProductTypeName.charAt(0).toUpperCase() + brandProductTypeName.slice(1)
                                        }}
                                    </h4>
                ...
                <div class="modal fade" id="disclaimerModal" tabindex="-1" aria-labelledby="disclaimerModal"
                    aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content !tw-bg-secondary">
                            <div class="modal-header border-0 p-0">
                            ...
                            <div class="modal-body p-0">
                                <div>
                                    ...
                                    <h3 class="modal-title">
                                        ...
                                        <small>
                                            ({{ __(":s products", {s:tempNote.products_count} ) }})
                                        </small>
                                    </h3>
                                ...
                                <div v-else>
                                    <div class="product-type mt-4" v-for="(productTypeProducts,
                                        ...
                                        <h4 class="mb-1 modal-title-sub">
                                            {{ productTypeName.charAt(0).toUpperCase() + productTypeName.slice(1) }}
                                        </h4>
                                ...
                                <div class="container">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <form class="mt-3 review-form">
                                            <div class="mb-3">
                                                <input type="text" class="form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black"
                                                    :class="{'is-invalid': errors.title}" placeholder="Title" required
                                                    v-model="reviewData.reviewForm.title" />
        ...
        methods: {
            ...
            addToCart() {
                if (!this.user) {
                    ...
                    return this.$inertia.get(this.route('login', { add_to_cart: this.product.id }));
            ...
            handleBtnScroll() {
                // check if this.$refs.targetSection in null
                if (!this.$refs.targetSection) {
