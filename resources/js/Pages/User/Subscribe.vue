            ...
            <form class="row justify-content-center" @submit.prevent="submitForm">
                <div class="col-md-7 col-lg-6">
                    <div class="billing-box checkout-credit-card-box">
                        <h3 class="mt-0 mb-2 !tw-text-base">
                            {{ __('Shipment Details') }}
                        </h3>
                        <!-- address  -->
                        <template v-for="(shipping, index) in shipping_addresses" :key="index">
                            <div class="md:tw-flex tw-justify-between tw-items-center !tw-bg-secondary tw-shadow-sm md:tw-p-6 tw-p-3 tw-rounded-md tw-mb-2 border-1 border-black tw-cursor-pointer"
                        ...
                        <template v-if="shipping_addresses.length != 0">
                            <div @click="addNew()"
                                class="tw-mt-2 md:tw-flex tw-justify-between tw-items-center !tw-bg-secondary tw-shadow-sm md:tw-p-6 tw-p-3 tw-rounded-md tw-cursor-pointer border">
                        ...
                        <div>
                            <template v-if="addNewAddress">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-floating">
                                            <input type="email" class="form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black" placeholder="Email Address"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-floating">
                                            <input type="text" class="form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black" placeholder="Street address" id="line1"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-floating">
                                            <input type="text" name="apt" class="form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black" placeholder="Apt (opt)" id="line2"
                                ...
                                <div class="form-group select2-box select2-small-box" v-if="statesAsSelect2.length">
                                    ...
                                    <v-select v-model="form.state" :reduce="(option) => option.id" class="" placeholder="Select State"
                                ...
                                <div class="form-group form-floating" v-else>
                                    <input type="text" name="city" class="form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black" placeholder="state" id="state"
                                ...
                                <div class="form-group form-floating">
                                    <input type="text" name="city" class="form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black" placeholder="city" id="city"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-floating">
                                            <input type="text" class="form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black" placeholder="post code" id="postal_code"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-floating">
                                            <input type="text" name="phone" @input="(e) => { onKeydown(e.target, 15) }"
                                                class="form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black" placeholder="phone" id="phone" v-model="form.phone" :class="{
                            ...
                            <div class="md:tw-hidden">
                                <side-bar :user_with_cart="user_with_cart" :arrivesInMonth="arrivesInMonth"
                                    :checkSubscriptionInCart="checkSubscriptionInCart" :checkOneTimeInCart="checkOneTimeInCart" :net_total="net_total"
                                    :config="config" :total="total" :errors="errors" :first_time_subscribe="first_time_subscribe" :all_plans="all_plans"
                                    :select_plan="select_plan" :plan="plan" @status="toggleCanvas" />
                            </div>
                            <div>
                                <div :style="{ display: form.gateway_id == 1 ? 'block' : 'none' }">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group stripe-input">
                                                <span id="card-number" class="!tw-h-[3rem] placeholder:!tw-text-red-500 form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group stripe-input">
                                                <span id="card-exp" class="!tw-h-[3rem] form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black"></span>
                                                <label class="form-label visually-hidden">{{ __("Card Exp") }}</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group stripe-input">
                                                <span id="card-cvc" class="!tw-h-[3rem] form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group form-floating stripe-input">
                                                <input type="text" name="full_name" class="form-control !tw-transition-all !tw-duration-300 !tw-bg-transparent !tw-rounded-[5px] !tw-border !tw-border-black" placeholder="Card Holder"
                                    ...
                                    <div class="row">
                                        <div class="form-group !tw-w-full tw-flex tw-justify-center tw-items-center">
                                            <button v-if="form.processing || cardInfo.processing" type="button"
                                                class="!tw-w-full !tw-flex !tw-justify-center !tw-py-3 !tw-items-center btn btn-black btn-lg texts-center text-uppercase" disabled>
                                                <svg class="tw-animate-spin " xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256">
                                                    <path
                ...
                <div class="tw-hidden md:tw-block col-md-5 col-xl-4 md:!tw-mt-[61px]">
                    <side-bar :user_with_cart="user_with_cart" :arrivesInMonth="arrivesInMonth"
                        :checkSubscriptionInCart="checkSubscriptionInCart" :checkOneTimeInCart="checkOneTimeInCart" :net_total="net_total"
                        :config="config" :total="total" :errors="errors" :first_time_subscribe="first_time_subscribe" :all_plans="all_plans"
                        :select_plan="select_plan" :plan="plan" @status="toggleCanvas" />
                        ...
                        <div class="d-flex">
                            ...
                            <div class="bottom-checkout-box-content">
                                ...
                                <p class="!tw-text-xs md:!tw-text-base">
                                    {{ __('All data is encrypted. Your card number is never stored on :app_name servers.', {app_name :
                                    config.app.name}) }}
                                </p>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        async submitForm() {
            if (this.itemCount != this.plan.product_count) {
                this.$inertia.visit(this.route('check.plan.cart'));
                return;
            }
    ...
    computed: {
        ...
        itemCount() {
            return this.user_cart.items ? this.user_cart.items.length : 0;
        },
        countriesAsSelect2() {
