                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    İndi istirahət edə bilərsiniz, məhsulunuzu sizə çatdırmaq üzərində
                                                    işləyirik
                                                    <span
                                                        style="font-style: normal;font-weight: 600;color: #000000; font-size: 16px;">ASAP!</span>
                                                    Əlavə etməyinizə əmin olun
                                                    məhsullar sıranıza <span
                                                        style="font-style: normal;font-weight: 600;color: #000000; font-size: 16px;">növbəti
                                                        12 saat</span> ona görə də sizin onları göndərmək üzərində
                                                    işləyə bilərik
                                                    Sən.
                                                </td>
                                            </tr>
                                    ...
                                    <table style="width: 100%; margin-top:32px; background: #F2F2F2; padding:24px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="3"
                                                    style="padding-top:12px; font-style: normal; color: #000000; font-weight: 400; font-size: 16px;line-height: 22px">
                                                    Scentbird-ə aydan aya abunə. Aylıq ödəniş edilir, yenilənir
                                                    avtomatik olaraq,
                                                    və gəmilər
                                                    ayın ortasında anbarımızdan.
                                                </td>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="2"
                                                    ...
                                                    Sifariş #{{ $order->order_no ?? $order->id }} From
