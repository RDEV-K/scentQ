                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    <span style="color: #000">ABUNƏLİYİNİZ</span> <br>
                                                    LƏĞV OLUNUB
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    Əziz {{ $user->first_name }} {{ $user->last_name }},
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="padding-top:12px;font-style: normal; font-weight: 400;font-size: 16px;line-height: 22px;">
                                                    Sorğunuz emal edildi və {{ config('app.name') }}
                                                    abunə idi
                                                    {{ $endDate }} tarixində ləğv edilib. Bir hissəsi olduğunuz
                                                    üçün sizə təşəkkür edirik
                                                    {{ config('app.name') }} və
                                                    getdiyinizi görməyə kədərlənirik.
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding-top: 20px;">
                                                    Zövq almaq üçün istənilən vaxt yenidən abunə olun <span
                                                        style="font-weight: 900;">50% Off</span>
                                                    və giriş
                                                    daha çox
                                                    900-dən çox premium ətirlər.
                                                </td>
                                            </tr>
                                            <tr>
