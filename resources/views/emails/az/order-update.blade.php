            ...
            <tr>
                <td>
                    <p style="font-weight: 400;font-size: 16px;line-height: 22px; color: #000000; margin-bottom: 12px;">
                        Sifariş nömrəsi: {{ $order->order_no ?? $order->id }}
                    </p>
                </td>
            </tr>
            <tr>
                <td>
                    <p style="font-weight: 400;font-size: 16px;line-height: 22px; color: #000000;">
                        Zəhmət olmasa, daha çox yeniləmə üçün sifariş təfərrüatları səhifəsini yoxlayın.
                    </p>
                </td>
            </tr>
            <tr>
                <td>
                    @foreach ($order->items as $item)
                        <table
                            style="display: flex !important; align-items:center !important; flex-direction: row;align-items: center;margin: 32px 0px; padding: 24px 16px;gap: 24px;background: #FFFFFF;border: 1px solid #E6E6E6;">
                            <tr>
                                <td>
            ...
            <tr>
                <td style="text-align: center;">
                    @component('mail::button', ['url' => route('order')])
                        ...
                        @elseif($order->status == 'completed')
                            Təcrübənizi nəzərdən keçirin
                        @else
                            Sifariş Tarixçəsini nəzərdən keçirin
                        @endif
                    @endcomponent
