...
<td>
<h2 class="temp-title">
Your subscription successfully added!
</h2>
</td>
</tr>
</table>
...
<h2 style="font-size: 24px; line-height: 32px; font-weight: 500;">Your Plan Info</h2>
...
<tr>
<td style="font-size: 16px; line-height: 24px; color: #000;">Price:</td>
<td style="font-size: 16px; line-height: 24px; color: #000; font-weight: 500;">{{ currencyConvertWithSymbol($plan->total_price) }}</td>
</tr>
<tr>
<td style="font-size: 16px; line-height: 24px; color: #000;">Monthly Product:</td>
