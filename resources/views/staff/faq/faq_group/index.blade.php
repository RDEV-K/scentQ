...
<div class="card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">@lang('FAQ Groups')</h5>
        <a href="{{ route('staff.faq-group.create') }}"
           class="btn btn-primary btn-sm">
           <i class="fa fa-plus">
            </i> @lang('Add New FAQ Group')
        </a>
    </div>
...
@section('js')
    <script>
        window.DatatableOptions = {
            ...
            processing: true,
            serverSide: true,
            ajax: @json(route('staff.faq-group.index')),
            columns: [
        ...
        (function ($) {
            $(document).on('click', '.btn-delete', function (e) {
                e.preventDefault();
                var id = $(this).data('id');
                var url = '{{ url("staff/faq-group") }}/' + id
