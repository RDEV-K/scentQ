    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">@lang('New Taxonomy')</h5>
                </div>
                <div class="card-body">
                    <form id="attribute-form" method="post" action="{{ route('staff.taxonomy.store') }}">
                        @csrf
                        @method('POST')
        ...
        <div class="col-md-8">
            <div class="card h-md-100">
                <div class="card-header">
                    <h4 class="mb-0">@lang('Taxonomies')</h4>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">@lang('Delete Taxonomy')</h4>
