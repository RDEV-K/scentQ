...
<div class="card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">@lang('All Shipping Policies')</h5>
        <a href="{{ route('staff.shipping-policy.create') }}"
           class="btn btn-primary btn-sm">
           <i class="fa fa-plus">
            </i> @lang('Add New Shipping Policy')
        </a>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">@lang('Delete shippingPolicy')</h4>
...
@section('js')
    <script>
        window.DatatableOptions = {
            ...
            processing: true,
            serverSide: true,
            ajax: @json(route('staff.shipping-policy.index')),
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
        ...
        (function ($) {
            $(document).on('click', '.btn-delete', function (e) {
                e.preventDefault();
                var id = $(this).data('id');
                var url = '{{ url('staff/shipping-policy') }}/' + id
