            ...
            <form action="{{ route('staff.brand.update', $brand->id) }}" method="post">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group text-center">
                            <img class="img-thumbnail w-100"
                                    ...
                                    id="logo-preview"
                            >
                            <input type="hidden" name="image" value="{{ $brand->image }}" id="logo-input">
                            <button
                    ...
                    <div class="col-md-8">
                        <div class="form-group text-center">
                            <img class="img-thumbnail w-100"
                                    src="{{ $brand->cover_image ??'https://via.placeholder.com/1208x621' }}"
                                    id="cover-preview"
                            >
                            <input type="hidden" name="cover_image" value="{{ $brand->cover_image }}" id="cover-input">
                            <button
                        ...
                        <div class="form-group">
                            ...
                            <select name="meta[add_to][]" id="meta-add_to" class="form-control selectpicker" multiple>
                                @foreach(\App\Models\Product::$types as $type)
                                    <option value="{{ $type }}" {{ is_array($brand_add_to) && in_array($type, $brand_add_to)?'selected':'' }}>{{ ucwords(str_replace('_', ' ', $type)) }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
