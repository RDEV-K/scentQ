...
<div class="card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">@lang('Badge List')</h5>
        <a href="{{ route('staff.badge.create') }}"
           class="btn btn-primary btn-sm">
           <i class="fa fa-plus">
            </i> @lang('Add New Badge')
        </a>
    </div>
...
@section('js')
    <script>
        window.DatatableOptions = {
            ...
            processing: true,
            serverSide: true,
            ajax: @json(route('staff.badge.index')),
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
