...
@section('content')
    <div class="card mb-3 p-4">
        ...
        <div class="card-body p-0">
            ...
            <form action="{{ route('staff.coupon.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <select name="customers[]" id="customers" class="form-control selectpicker" multiple>
                                @foreach($customers as $customer)
                                    <option value="{{ $customer->id }}" {{ is_array(old('customers')) && in_array($customer->id, old('customers'))?'selected':'' }}>{{ $customer->first_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="products[]" id="products" class="form-control selectpicker" multiple>
                                @foreach($products as $product)
                                    <option value="{{ $product->id }}" {{ is_array(old('products')) && in_array($product->id, old('products'))?'selected':'' }}>{{ $product->title }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
