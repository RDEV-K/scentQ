...
<div class="card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">@lang('All Plans')</h5>
        <a href="{{ route('staff.plan.create') }}"
           class="btn btn-primary btn-sm"><i
                class="fa fa-plus"></i> @lang('Add New plan')
        </a>
    </div>
            ...
            <div class="col-12">
                <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100"
                    ...
                    <tr>
                        ...
                        <th>@lang('Price/Product')</th>
                        <th>@lang('Total Price')</th>
                        {{-- <th>@lang('Tax')</th> --}}
                        <th>@lang('Free Shipping')</th>
                        <th>@lang('Action')</th>
                    </tr>
                    </thead>
                </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">@lang('Delete Plan')</h4>
...
<script>
    window.DatatableOptions = {
            ...
            processing: true,
            serverSide: true,
            ajax: @json(route('staff.plan.index')),
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'Name'},
                {data: 'type', name: 'Type'},
                {data: 'product_count', name: 'product_count'},
                {data: 'price_par_product', name: 'price_par_product'},
