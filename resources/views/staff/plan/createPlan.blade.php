...
@section('content')
    <div class="card mb-3 p-5">
        ...
        <div class="card-body" id="ooo" v-cloak>
            ...
            <form action="{{ route('staff.plan.store') }}" method="post">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="free_product_id" id="free_product_id" class="form-control selectpicker">
                                <option value="">@lang('No Product')</option>
                                @foreach($products as $product)
                                    <option
                                        value="{{ $product->id }}" {{ old('free_product_id') == $product->id?'selected':'' }}>{{ $product->title }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="mb-3"
                                   style="visibility: hidden; width: 100%">@lang('Hidden')</label>
                            <div class="d-flex align-items-center">
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input"
                                           id="personal" type="radio" name="type"
                                           v-model="type" value="personal">
                                    <label class="custom-control-label"
                                           for="personal">@lang('Personal')</label>
                                </div>
                                <div class="custom-control custom-radio ml-7">
                                    <input class="custom-control-input" id="gift"
                                           type="radio" name="type"
                                           v-model="type" value="gift">
                                    <label class="custom-control-label"
                                           for="gift">@lang('Gift')</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div :class="(type == 'personal')?'col-md-4':'col-md-6' ">
                        <div class="form-group">
                            <label class="control-label">@lang('Price/Product')</label>
                            <div class="input-group">
                                <input type="number" step="0.01" min="0"
                                       name="price_par_product"
                                       class="form-control" required
                                       v-model="price_par_product">
                    ...
                    <div class="col-md-4" v-if="type == 'personal' ">
                        <div class="form-group">
                            <label class="control-label">@lang('Total Price')</label>
                            <div class="input-group">
                    ...
                    <div :class="(type == 'personal')?'col-md-4':'col-md-6' ">
                        <div class="form-group">
                            <label
                                for="product_count">@lang('Product Count/month')</label>
                ...
                <div class="row" v-if="type == 'personal'">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   name="stripe_coupon"
                                   class="form-control" value="{{ old('stripe_coupon') }}">
                        </div>
                    </div> --}}
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="first_time_coupon_id" id="first_time_coupon_id" class="form-control selectpicker">
                                ...
                                @foreach($coupons as $coupon)
                                    <option
                                        value="{{ $coupon->id }}" {{ old('first_time_coupon_id') == $coupon->id?'selected':'' }}>{{ $coupon->code }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="interval_count" type="number" min="1" step="1" class="form-control"
                                       name="interval_count" value="{{ old('interval_count') }}">
                                <div class="input-group-append">
...
{{--                    </div>--}}
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="mb-3"
                                   style="visibility: hidden">@lang('Hidden')</label>
                            <div class="d-flex ">
                ...
                <div id="gift" v-if="type == 'gift' ">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    for="gift_month_count">@lang('Gift Month Count')</label>
                                <input type="number" step="01" min="1"
                                       name="gift_month_count"
                                       value="{{ old('gift_month_count') }}"
                                       class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        {{-- <div class="col-md-6">
                            <div class="form-group">
                                <label
                                    for="gift_personal_receive">@lang('Gift Personal Receive')</label>
                                <input type="number" step="01" min="1"
                                       name="gift_personal_receive"
                                       value="{{ old('gift_personal_receive') }}"
                                       class="form-control" required>
                            </div>
                        </div> --}}
                    </div>
                    <div class="row">
                        <div class="col-md-6" v-for="(feature, ind) in features"
                             :key="ind">
                            <div class="form-group">
                                <label :for="'feature-' + ind">@lang("Feature") @{{
                                    ind+1 }}
                                    <button class="btn btn-sm btn-warning"
                                            type="button"
                                            @click.prevent="removeFeature(ind)"><i
                                            class="fas fa-trash"></i>
                                    </button>
                                </label>
                                <input class="form-control" :id="'feature-' + ind"
                                       name="features[]"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label style="visibility: hidden">@lang('Add New Featur')</label>
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="form-group text-right">
                            <button class="btn btn-primary btn-lg"
                                    type="submit">@lang('Save Plan')</button>
                        </div>
                    </div>
                </div>
            </form>
...
@section('js')
    <script>
        window.vueApp = new Vue({
            el: '#ooo',
            data: {
                type: @json(old('type')??'personal'),
                product_count: @json(old('product_count')??1),
                price_par_product: @json(old('price_par_product')??1),
