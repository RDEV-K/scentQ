...
utils.$document.ready(function () {
    ...
    dataTables.length && dataTables.each(function (index, value) {
        ...
        }, window.DatatableOptions); // $this.data('options')
...
utils.$document.ready(function () {
    ...
    if (tinymces.length) {
        var editor_config = {
            path_absolute: window.mediaManagerPath,
            selector: ".tinymce",
            ...
            file_picker_callback: function (callback, value, meta) {
                ...
                var cmsURL = editor_config.path_absolute + 'staff/media?editor=' + meta.fieldname;
        ...
        window.tinymce.init(editor_config);
    }
});
/*-----------------------------------------------
|   Toast [bootstrap 4]
